...
{
    public class Lay : Place, IHasVig
    {
        public Lay(Table table) : base(table)
        {
        }
        ...
        internal override void ProcessRoll(Dice roll)
        {
            ...
            if (roll.Total == Point)
            {
                ...
                {
                    case 4 or 10:
                        bo.Payout = (0.5 * Wager).FuzzyFloor(); //1:2
                        break;
                    case 5 or 9:
                        bo.Payout = (0.6666 * Wager).FuzzyFloor(); //2:3
                        break;
                    case 6 or 8:
                        bo.Payout = (0.8333 * Wager).FuzzyFloor(); //5:6
                        break;
                    default:
